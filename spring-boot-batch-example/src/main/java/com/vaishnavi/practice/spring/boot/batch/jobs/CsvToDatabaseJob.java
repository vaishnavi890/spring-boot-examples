package com.vaishnavi.practice.spring.boot.batch.jobs;

import com.vaishnavi.practice.spring.boot.batch.jobs.csvToDb.listener.JobCompletionNotificationListener;
import com.vaishnavi.practice.spring.boot.batch.jobs.csvToDb.listener.PersonItemReadListener;
import com.vaishnavi.practice.spring.boot.batch.jobs.csvToDb.model.Person;
import com.vaishnavi.practice.spring.boot.batch.jobs.csvToDb.processor.PersonItemProcessor;
import com.vaishnavi.practice.spring.boot.batch.jobs.csvToDb.tasklet.DeleteInputCsvTasklet;
